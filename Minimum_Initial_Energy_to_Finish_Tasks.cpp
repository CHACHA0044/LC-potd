...
public:
    int minimumEffort(vector<vector<int>>& tasks) {
        ...
        We should do tasks with larger:
            (minimum - actual)
        ...
        Because those tasks require a large reserve energy
        but consume relatively less.

        Sorting this way minimizes initial energy needed.
        */
