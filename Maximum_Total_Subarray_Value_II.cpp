...
public:
    long long maxTotalValue(vector<int>& nums, int k) {
        ...
        we maintain the currently largest
        remaining subarray.
        */
        ...
        start with the longest subarray
        [l ... n-1].

        This gives the largest value
        for that sequence.
        */
        for (int l = 0; l < n; l++) {
        ...
        /*
        Extract the largest subarray value
        exactly k times.
        */
        while (k--) {
